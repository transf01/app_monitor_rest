# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-14 06:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('interviewer', models.CharField(max_length=400, verbose_name='이름')),
                ('interviewee', models.CharField(max_length=400, verbose_name='연락처')),
                ('conditions', models.CharField(max_length=400, verbose_name='성별')),
                ('comments', models.CharField(max_length=400, verbose_name='나이')),
